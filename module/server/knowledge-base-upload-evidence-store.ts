...
import type {createKnowledgeBaseUploadEvidenceLifecycle} from "./knowledge-base-upload-evidence-lifecycle.js";
...
export interface KnowledgeUploadEvidenceStoreCore extends KnowledgeLocalSourceCore, Pick<ReturnType<typeof createKnowledgeBaseUploadEvidenceLifecycle>,"knowledgeBaseUploadEvidenceStorageKey"> {}
export function createKnowledgeBaseUploadEvidenceStore(core: KnowledgeUploadEvidenceStoreCore) {
const { installImmutableFileAtomically, knowledgeBaseUploadEvidenceStorageKey } = core;
...
async function persistKnowledgeBaseUploadEvidence(input: {
  userId: number;
  buildId: string;
  generation: number;
  packageArchiveSha256: string;
...
async function readKnowledgeBaseUploadEvidence(input: {
  userId: number;
  buildId: string;
  generation: number;
  packageArchiveSha256: string;
...
async function readKnowledgeBasePersistedCustomerUploadBytes(input: {
  userId: number;
  buildId: string;
  generation: number;
  packageArchiveSha256: string;
 ...
 */
async function readReusableKnowledgeBaseUploadEvidenceBytes(input: {
  userId: number;
  buildId: string;
  generation: number;
  packageArchiveSha256: string;
...
return { persistKnowledgeBaseUploadEvidence, readKnowledgeBaseUploadEvidence, readKnowledgeBasePersistedCustomerUploadBytes, readReusableKnowledgeBaseUploadEvidenceBytes };
}
