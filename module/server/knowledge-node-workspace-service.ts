...
export interface KnowledgeNodeWorkspaceServiceCore {
  ...
  selectMaterializedKnowledgeBaseNode: typeof import("./knowledge-base-materialized-service.js").selectMaterializedKnowledgeBaseNode;
  ...
  knowledgeBaseMaterializedCompletionContractVersion: typeof import("./knowledge-base-turn-service.js").knowledgeBaseMaterializedCompletionContractVersion;
  knowledgeBaseMaterializedRecoveryContractVersion: typeof import("./knowledge-base-turn-service.js").knowledgeBaseMaterializedRecoveryContractVersion;
  reserveKnowledgeBaseTurnInTransaction: typeof import("./knowledge-base-turn-service.js").reserveKnowledgeBaseTurnInTransaction;
  ...
  dispatchManualKnowledgeNodeEdit: typeof import("./knowledge-node-manual-edit-service.js").dispatchManualKnowledgeNodeEdit;
}
let lockCustomerProjectBusinessWrite: KnowledgeNodeWorkspaceServiceCore["lockCustomerProjectBusinessWrite"];
let knowledgeWorkbenchEditingAllowed: KnowledgeNodeWorkspaceServiceCore["knowledgeWorkbenchEditingAllowed"];
let conversationTurns: KnowledgeNodeWorkspaceServiceCore["conversationTurns"];
let knowledgeBaseBuildNodes: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseBuildNodes"];
let knowledgeBaseBuilds: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseBuilds"];
let knowledgeBaseWorkingSets: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseWorkingSets"];
let getDb: KnowledgeNodeWorkspaceServiceCore["getDb"];
let enterpriseOwnerPredicate: KnowledgeNodeWorkspaceServiceCore["enterpriseOwnerPredicate"];
let enterpriseProjectUrl: KnowledgeNodeWorkspaceServiceCore["enterpriseProjectUrl"];
let enterpriseResetStateTable: KnowledgeNodeWorkspaceServiceCore["enterpriseResetStateTable"];
let enterpriseResetStateOwnerPredicate: KnowledgeNodeWorkspaceServiceCore["enterpriseResetStateOwnerPredicate"];
let selectMaterializedKnowledgeBaseNode: KnowledgeNodeWorkspaceServiceCore["selectMaterializedKnowledgeBaseNode"];
let knowledgeBaseWorkingSetAssetInternalIdentity: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseWorkingSetAssetInternalIdentity"];
let knowledgeBasePublicResource: KnowledgeNodeWorkspaceServiceCore["knowledgeBasePublicResource"];
let isMaterializedBuildPublishable: KnowledgeNodeWorkspaceServiceCore["isMaterializedBuildPublishable"];
let canonicalKnowledgeBaseMarkdown: KnowledgeNodeWorkspaceServiceCore["canonicalKnowledgeBaseMarkdown"];
let knowledgeBaseMarkdownSha256: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseMarkdownSha256"];
let knowledgeBaseWritesAreEmergencyBlocked: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseWritesAreEmergencyBlocked"];
let knowledgeBaseMaterializedCompletionContractVersion: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseMaterializedCompletionContractVersion"];
let knowledgeBaseMaterializedRecoveryContractVersion: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseMaterializedRecoveryContractVersion"];
let reserveKnowledgeBaseTurnInTransaction: KnowledgeNodeWorkspaceServiceCore["reserveKnowledgeBaseTurnInTransaction"];
let knowledgeBaseObservationConversationStorageId: KnowledgeNodeWorkspaceServiceCore["knowledgeBaseObservationConversationStorageId"];
let dispatchManualKnowledgeNodeEdit: KnowledgeNodeWorkspaceServiceCore["dispatchManualKnowledgeNodeEdit"];
export function configureKnowledgeNodeWorkspaceService(core:KnowledgeNodeWorkspaceServiceCore) { ({lockCustomerProjectBusinessWrite,knowledgeWorkbenchEditingAllowed,conversationTurns,knowledgeBaseBuildNodes,knowledgeBaseBuilds,knowledgeBaseWorkingSets,getDb,enterpriseOwnerPredicate,enterpriseProjectUrl,enterpriseResetStateTable,enterpriseResetStateOwnerPredicate,selectMaterializedKnowledgeBaseNode,knowledgeBaseWorkingSetAssetInternalIdentity,knowledgeBasePublicResource,isMaterializedBuildPublishable,canonicalKnowledgeBaseMarkdown,knowledgeBaseMarkdownSha256,knowledgeBaseWritesAreEmergencyBlocked,knowledgeBaseMaterializedCompletionContractVersion,knowledgeBaseMaterializedRecoveryContractVersion,reserveKnowledgeBaseTurnInTransaction,knowledgeBaseObservationConversationStorageId,dispatchManualKnowledgeNodeEdit}=core); }
...
} from "../contracts/knowledge-node-workspace.js";



import {KnowledgeBaseMaterializedError} from "./knowledge-base-materialized-service.js";
import {projectKnowledgeBaseCustomerMarkdown, type KnowledgeBaseWorkingSetManifest} from "../contracts/knowledge-base-materialized-contract.js";





import {KnowledgeBaseTurnReservationError, type KnowledgeBaseRecoveryClaim} from "./knowledge-base-turn-service.js";
