...
import {KNOWLEDGE_BASE_SKILL_ATTACHMENT_FILENAME} from './knowledge-base-skill-runtime.js';
import {assertKnowledgeBaseCustomerUploadCapacity,assertKnowledgeBaseManifestDoesNotRepeatOfficialLogo,buildFinalizationInputForTurn,knowledgeBaseBuildRequiresOfficialLogo,knowledgeBaseManifestRepeatsOfficialLogo,knowledgeBaseTurnRequiresFinalPackage,loadKnowledgeBaseBuildRecord,loadKnowledgeBaseBuildRecordById,shouldBindKnowledgeBaseInitialLogo} from './knowledge-base-final-turn-service.js';
import {applyKnowledgeBaseFinalLogoProvenanceObservation,assertKnowledgeBaseFinalLogoProvenanceForBuild,inspectKnowledgeBaseFinalLogoProvenance} from './knowledge-base-logo-provenance-repair.js';
import {classifyKnowledgeBaseUpstreamCreateFailure,knowledgeBaseArtifactFailureNotice,KnowledgeBaseAttachmentsProcessingError,KnowledgeBaseLocalPreparationError,KnowledgeBaseUpstreamCreateError} from './knowledge-base-api-errors.js';
...
import {createKnowledgeBaseUploadRouter} from './knowledge-base-upload-api.js';
import {persistKnowledgeBaseExecution,persistKnowledgeBaseStage} from './knowledge-base-execution.js';
import {failKnowledgeBaseUpload,recordKnowledgeBaseUploadHeartbeat} from './knowledge-base-turn-service.js';
import {toKnowledgeBasePublicPayload} from './knowledge-base-public-projection.js';
import {KNOWLEDGE_BASE_RESPONSE_HEADER,knowledgeBaseProgressResponse} from './knowledge-base-progress-response.js';
import {KnowledgeBaseBuildError,assertKnowledgeBaseTaskBinding,classifyKnowledgeBaseUserAction,extractFinalKnowledgeBaseAssistantText,getKnowledgeBaseProgress,getKnowledgeBaseObservationProjection,hasClosedKnowledgeBasePresentationEnvelope,hasClosedKnowledgeBaseStateEnvelope,isAmbiguousKnowledgeBaseAdvance,isIdempotentKnowledgeBaseReconcileError,isKnowledgeBaseAcknowledgementOnlyOutput,knowledgeBaseProtocolErrorAllowsSameTaskRecovery,observeKnowledgeBaseOperationalFailure,observeKnowledgeBaseProtocolFailure,reconcileKnowledgeBaseProgress,resumeKnowledgeBaseFinalPackageMissing} from './knowledge-base-progress-service.js';
import {normalizeKnowledgeBaseAttachmentMimeType} from '../contracts/knowledge-base-attachment.js';
import {extractKnowledgeBaseProtocolObjects} from '../contracts/knowledge-base-output.js';
import {classifyKnowledgeBaseUpstreamTaskStatus,formatKnowledgeBaseManifestEnvelope,formatKnowledgeBasePresentationEnvelope,formatKnowledgeBaseProgressEnvelope,KNOWLEDGE_BASE_MANIFEST_KIND,KNOWLEDGE_BASE_PRESENTATION_KIND,KNOWLEDGE_BASE_PROGRESS_KIND,KNOWLEDGE_BASE_PROTOCOL_V4_SCHEMA_VERSION,parseKnowledgeBasePresentationEnvelope,parseKnowledgeBaseProgressEnvelope,parseKnowledgeBaseManifestEnvelope,validateKnowledgeBaseManifestForTreePolicy} from '../contracts/knowledge-base-progress.js';
import {knowledgeBaseInteractionTelemetryEvents} from './knowledge-base-interaction-telemetry.js';
import {logKnowledgeBaseDispatchPhaseTelemetry,logKnowledgeBaseOperationTelemetry,type KnowledgeBaseDispatchPhase} from './knowledge-base-operation-telemetry.js';
import {bindKnowledgeBaseFinalPackage,bindKnowledgeBaseInitialLogo,bindKnowledgeBaseOfficialLogoUpload,bindKnowledgeBaseReadyPackage,assertKnowledgeBaseOfficialLogoUploadCandidate,cleanupKnowledgeBaseStagedArtifactCandidate,collectKnowledgeBaseLogoDescriptors,KnowledgeBaseArtifactBindingError,type KnowledgeBaseInitialLogoDisposition,type KnowledgeBaseOfficialLogoUpload,type KnowledgeBaseStagedArtifactCandidate} from './knowledge-base-artifact-binding-service.js';
import {collectKnowledgeArchiveDescriptors,knowledgeArchivePhysicalDescriptorHash} from './knowledge-base-artifact.js';
import {beginKnowledgeBaseManusV2Dispatch,bindKnowledgeBaseManusV2Submission,cancelUnpreparedKnowledgeBaseTurn,cancelIncompleteKnowledgeBaseStart,cancelIncompleteKnowledgeBaseRevision,claimKnowledgeBaseDeferredTurnDispatch,claimKnowledgeBaseTurnForRecovery,settleKnowledgeBaseManusV2ExplicitRejection,settleKnowledgeBasePreCreateFailureForApprovedReset,deferKnowledgeBaseTurnBeforeCreate,ensureKnowledgeBaseBuildSkillArchivePin,failKnowledgeBaseMaterializedResultForApprovedReset,deferKnowledgeBaseMaterializedResultRead,findRecoverableKnowledgeBaseTurnIds,failKnowledgeBaseTurnDeterministically,freezeKnowledgeBaseTurnAttachments,inspectKnowledgeBaseDeferredAttachmentReplay,inspectKnowledgeBaseDeferredDispatchReplay,inspectKnowledgeBaseLegacyAttachmentTakeoverReplay,inspectKnowledgeBaseLegacyDeferredReservationReplay,inspectKnowledgeBaseTurnReplay,knowledgeBaseMaterializedRecoveryContractVersion,markKnowledgeBaseTurnOutcomeUnknown,markKnowledgeBaseManusV2OutcomeUnknown,deferKnowledgeBaseMaterializedProviderStatus,pauseKnowledgeBasePreCreateCredentialUnavailable,prepareKnowledgeBaseTurnDispatch,reserveKnowledgeBaseGeneratedAttachment,reserveKnowledgeBaseStartBuild,reserveKnowledgeBaseTurn,rejectAcknowledgedKnowledgeBaseManualLogoTurn,rejectUnacknowledgedKnowledgeBaseManualLogoTurn,renewKnowledgeBaseTurnLease,observeKnowledgeBaseMaterializedResultDiagnostic,stageKnowledgeBaseDeferredTurnAttachment,stageKnowledgeBaseTurnAttachments,KnowledgeBaseTurnReservationError,type KnowledgeBaseGeneratedAttachmentReservation,type KnowledgeBaseGeneratedAttachmentRole,type KnowledgeBaseRecoveryClaim,type KnowledgeBaseDeferredDispatchClaim,type KnowledgeBaseTurnReservation,type KnowledgeBaseMaterializedResultDiagnostic,knowledgeBaseMaterializedCompletionContractVersion} from './knowledge-base-turn-service.js';
import {assertCapturedKnowledgeBaseCustomerImage} from './knowledge-base-customer-upload.js';
import {activateInitialKnowledgeBaseWorkingSet,applyKnowledgeBaseRevisionWorkingSet,bindMaterializedKnowledgeBaseOfficialLogoLocally,confirmMaterializedKnowledgeBaseNode,selectMaterializedKnowledgeBaseNode,KnowledgeBaseMaterializedError,MATERIALIZED_KNOWLEDGE_BASE_EXECUTION_MODE,readActiveKnowledgeBaseWorkingSet,validateKnowledgeBaseRevisionAgainstActiveWorkingSet} from './knowledge-base-materialized-service.js';
import {isMaterializedBuildPublishable} from './knowledge-base-materialized-quality.js';
import {KnowledgeBaseMaterializedContractError,normalizeMaterializedKnowledgeBaseResult,validateKnowledgeBaseWorkingSetArchive,type KnowledgeBaseInitialBundleExpectation,type KnowledgeBaseNormalizationOutcome,type KnowledgeBaseResultProcessingStage} from '../contracts/knowledge-base-materialized-contract.js';
import {KNOWLEDGE_BASE_MATERIALIZED_COMPLETION_CONTRACT_VERSION} from './knowledge-base-materialized-completion-contract.js';
import {assertKnowledgeBaseAttachmentManifestPresent,normalizeKnowledgeBaseClientAttachmentManifest,normalizeKnowledgeBaseUserAttachments,type KnowledgeBaseAttachment,type KnowledgeBaseClientAttachmentManifestItem} from './knowledge-base-client-attachment-manifest.js';
import {knowledgeBaseNewBuildPolicyBinding,KNOWLEDGE_BASE_MATERIALIZED_V5_SKILL_CONTENT_HASH} from './knowledge-base-tree-policy-rollout.js';
import {canonicalizeKnowledgeBaseCompanyName,canonicalizeKnowledgeBaseWebsite} from './knowledge-base-company-identity.js';
import {createKnowledgeBaseLogoProvenanceErrorResponder,createKnowledgeBaseLogoProvenanceRouter} from './knowledge-base-logo-provenance-api.js';
import type {KnowledgeBaseInteractionDto} from "../contracts/knowledge-base-public-progress.js";
import type {KnowledgeBaseObservationDto} from "../contracts/knowledge-base-public-progress.js";
import type {KnowledgeBaseProgressDto} from "../contracts/knowledge-base-public-progress.js";
type ManusV2Client=KnowledgeAgentClient;
type ManusV2ApiError=InstanceType<KnowledgeBaseApiCore["ManusV2ApiError"]>;
type ManusV2KnowledgeBaseOperationContract=any;
import type {ManusV2MessageEvent} from './siteops/provider-ports.js';
type KnowledgeBaseUpstreamCreateFailureClass=any;
export interface KnowledgeBaseApiCore {
 tables:BrandSchema;
getKnowledgeImageLibrary:Port;
saveKnowledgeImageLibrary:Port;
acceptKnowledgeBaseInitialDraft:Port;
exportKnowledgeBaseWorkspace:Port;
runWithStoredEnterpriseProjectScope:Port;
sendAiBillingError:Port;
assertAiAccountFunds:Port;
assertKnowledgeBaseDispatchFunds:Port;
continueKnowledgeBaseAfterRecharge:Port;
pauseKnowledgeBaseForBilling:Port;
enterpriseWorkspaceUserId:Port;
knowledgeBaseWorkingSetAssetUrl:Port;
enterpriseProjectUrl:Port;
dispatchKnowledgeNodeEdit:Port;
dispatchManualKnowledgeNodeEdit:(...args:any[])=>Promise<{reconciled:boolean}>;
getKnowledgeNodeDetails:Port;
saveKnowledgeNodeContent:Port;
searchKnowledgeNodes:Port;
KNOWLEDGE_NODE_IMAGE_MIMES:readonly string[];
createCredentialAgentClient:(credential:KnowledgeCredential,options?:any)=>KnowledgeAgentClient;
getUpstreamBaseUrl:Port;
AuthServiceError:new(...args:any[])=>Error&{code:string;retryAfterMs?:number};
getDecryptedCredentialForKnowledgeBaseReservation:(...args:any[])=>Promise<KnowledgeCredential|null>;
getDecryptedCredentialForKnowledgeBaseUploadReservation:(...args:any[])=>Promise<KnowledgeCredential|null>;
recordUpstreamResource:Port;
getDashboardWorkspace:Port;
getKnowledgeSnapshotById:Port;
getLatestKnowledgeSnapshot:Port;
downloadArchiveBytes:(input:any)=>Promise<{buffer:Buffer;filename:string}>;
publishKnowledgeBaseBuild:Port;
KnowledgeArchiveDownloadError:typeof import('./knowledge-archive-download-error.js').KnowledgeArchiveDownloadError;
...
UpstreamTaskAttachmentContentProofError:new(...args:any[])=>Error&{code:string;retryable:boolean};
UpstreamTaskAttachmentPendingError:new(...args:any[])=>Error&{code:string};
assertKnowledgeBaseWritable:Port;
parseExactJson:Port;
buildManusV2CreateTaskBody:Port;
latestManusV2TaskState:Port;
ManusV2ApiError:new(...args:any[])=>import('./siteops/provider-ports.js').ProviderError;
manusV2KnowledgeBaseStructuredResultForOperation:Port;
normalizeManusV2Output:Port;
...
ensureKnowledgeBaseManusV2Attachments:Port;
isKnowledgeBaseManusV2GeneratedFileCreateRejected:Port;
readStoredPresalesFile:(...args:any[])=>Promise<{sizeBytes:number;recordedSizeBytes:number|null;sha256:string|null;filename:string;mimeType:string;createReadStream():import("node:stream").Readable}|null>;
persistKnowledgeBaseBuildSource:Port;
persistKnowledgeBaseGeneratedSource:Port;
readKnowledgeBaseLocalSource:Port;
ManagedUploadIntentError:new(...args:any[])=>Error&{code:string;statusCode:number;retryable:boolean;retryAfterMs?:number};
logKnowledgeBaseRuntimeFailure:Port;
getKnowledgeBaseSkillDescriptor:Port;
knowledgeBasePinnedV4SkillSelection:Port;
readKnowledgeBaseSkillArchiveAttachment:Port;
buildKnowledgeBasePrefillEvidenceArchive:Port;
buildKnowledgeBasePrompt:Port;
KnowledgeBaseEnterpriseIdentityError:typeof import('./knowledge-base-prompt-contract.js').KnowledgeBaseEnterpriseIdentityError;
KNOWLEDGE_BASE_PREFILL_ATTACHMENT_FILENAME:string;
resolveKnowledgeBaseEnterpriseIdentity:Port;
buildKnowledgeBaseInstructionDelivery:Port;
KNOWLEDGE_BASE_INSTRUCTIONS_FILENAME:string;
buildKnowledgeBaseTurnPrompt:Port;
UpstreamPromptBudgetError:new(...args:any[])=>Error;
UpstreamFileReadinessError:new(...args:any[])=>Error&{code:string;retryable:boolean};
canonicalUpstreamTask:Port;
upstreamTaskId:Port;
credentialForRequest(request:Request):KnowledgeCredential|undefined;
withCredentialScope<T>(action:()=>T):T;
}
let knowledgeBaseBuildNodes:BrandSchema['knowledgeBaseBuildNodes'];
let getKnowledgeImageLibrary:KnowledgeBaseApiCore['getKnowledgeImageLibrary'];
let saveKnowledgeImageLibrary:KnowledgeBaseApiCore['saveKnowledgeImageLibrary'];
let acceptKnowledgeBaseInitialDraft:KnowledgeBaseApiCore['acceptKnowledgeBaseInitialDraft'];
let exportKnowledgeBaseWorkspace:KnowledgeBaseApiCore['exportKnowledgeBaseWorkspace'];
let runWithStoredEnterpriseProjectScope:KnowledgeBaseApiCore['runWithStoredEnterpriseProjectScope'];
let sendAiBillingError:KnowledgeBaseApiCore['sendAiBillingError'];
let assertAiAccountFunds:KnowledgeBaseApiCore['assertAiAccountFunds'];
let assertKnowledgeBaseDispatchFunds:KnowledgeBaseApiCore['assertKnowledgeBaseDispatchFunds'];
let continueKnowledgeBaseAfterRecharge:KnowledgeBaseApiCore['continueKnowledgeBaseAfterRecharge'];
let pauseKnowledgeBaseForBilling:KnowledgeBaseApiCore['pauseKnowledgeBaseForBilling'];
let enterpriseWorkspaceUserId:KnowledgeBaseApiCore['enterpriseWorkspaceUserId'];
let knowledgeBaseWorkingSetAssetUrl:KnowledgeBaseApiCore['knowledgeBaseWorkingSetAssetUrl'];
let enterpriseProjectUrl:KnowledgeBaseApiCore['enterpriseProjectUrl'];
let dispatchKnowledgeNodeEdit:KnowledgeBaseApiCore['dispatchKnowledgeNodeEdit'];
let dispatchManualKnowledgeNodeEdit:KnowledgeBaseApiCore['dispatchManualKnowledgeNodeEdit'];
let getKnowledgeNodeDetails:KnowledgeBaseApiCore['getKnowledgeNodeDetails'];
let saveKnowledgeNodeContent:KnowledgeBaseApiCore['saveKnowledgeNodeContent'];
let searchKnowledgeNodes:KnowledgeBaseApiCore['searchKnowledgeNodes'];
let KNOWLEDGE_NODE_IMAGE_MIMES:KnowledgeBaseApiCore['KNOWLEDGE_NODE_IMAGE_MIMES'];
let createCredentialAgentClient:KnowledgeBaseApiCore['createCredentialAgentClient'];
let getUpstreamBaseUrl:KnowledgeBaseApiCore['getUpstreamBaseUrl'];
let AuthServiceError:KnowledgeBaseApiCore['AuthServiceError'];
let getDecryptedCredentialForKnowledgeBaseReservation:KnowledgeBaseApiCore['getDecryptedCredentialForKnowledgeBaseReservation'];
let getDecryptedCredentialForKnowledgeBaseUploadReservation:KnowledgeBaseApiCore['getDecryptedCredentialForKnowledgeBaseUploadReservation'];
let recordUpstreamResource:KnowledgeBaseApiCore['recordUpstreamResource'];
let getDashboardWorkspace:KnowledgeBaseApiCore['getDashboardWorkspace'];
let getKnowledgeSnapshotById:KnowledgeBaseApiCore['getKnowledgeSnapshotById'];
let getLatestKnowledgeSnapshot:KnowledgeBaseApiCore['getLatestKnowledgeSnapshot'];
let downloadArchiveBytes:KnowledgeBaseApiCore['downloadArchiveBytes'];
let publishKnowledgeBaseBuild:KnowledgeBaseApiCore['publishKnowledgeBaseBuild'];
let KnowledgeArchiveDownloadError:KnowledgeBaseApiCore['KnowledgeArchiveDownloadError'];
let assertServiceCapability:KnowledgeBaseApiCore['assertServiceCapability'];
let ServiceEntitlementError:KnowledgeBaseApiCore['ServiceEntitlementError'];
let getDb:KnowledgeBaseApiCore['getDb'];
let UpstreamTaskAttachmentContentProofError:KnowledgeBaseApiCore['UpstreamTaskAttachmentContentProofError'];
let UpstreamTaskAttachmentPendingError:KnowledgeBaseApiCore['UpstreamTaskAttachmentPendingError'];
let assertKnowledgeBaseWritable:KnowledgeBaseApiCore['assertKnowledgeBaseWritable'];
let parseExactJson:KnowledgeBaseApiCore['parseExactJson'];
let buildManusV2CreateTaskBody:KnowledgeBaseApiCore['buildManusV2CreateTaskBody'];
let latestManusV2TaskState:KnowledgeBaseApiCore['latestManusV2TaskState'];
let ManusV2ApiError:KnowledgeBaseApiCore['ManusV2ApiError'];
let manusV2KnowledgeBaseStructuredResultForOperation:KnowledgeBaseApiCore['manusV2KnowledgeBaseStructuredResultForOperation'];
let normalizeManusV2Output:KnowledgeBaseApiCore['normalizeManusV2Output'];
let orderManusV2EventsByProviderRank:KnowledgeBaseApiCore['orderManusV2EventsByProviderRank'];
let ensureKnowledgeBaseManusV2Attachments:KnowledgeBaseApiCore['ensureKnowledgeBaseManusV2Attachments'];
let isKnowledgeBaseManusV2GeneratedFileCreateRejected:KnowledgeBaseApiCore['isKnowledgeBaseManusV2GeneratedFileCreateRejected'];
let readStoredPresalesFile:KnowledgeBaseApiCore['readStoredPresalesFile'];
let persistKnowledgeBaseBuildSource:KnowledgeBaseApiCore['persistKnowledgeBaseBuildSource'];
let persistKnowledgeBaseGeneratedSource:KnowledgeBaseApiCore['persistKnowledgeBaseGeneratedSource'];
let readKnowledgeBaseLocalSource:KnowledgeBaseApiCore['readKnowledgeBaseLocalSource'];
let ManagedUploadIntentError:KnowledgeBaseApiCore['ManagedUploadIntentError'];
let logKnowledgeBaseRuntimeFailure:KnowledgeBaseApiCore['logKnowledgeBaseRuntimeFailure'];
let getKnowledgeBaseSkillDescriptor:KnowledgeBaseApiCore['getKnowledgeBaseSkillDescriptor'];
let knowledgeBasePinnedV4SkillSelection:KnowledgeBaseApiCore['knowledgeBasePinnedV4SkillSelection'];
let readKnowledgeBaseSkillArchiveAttachment:KnowledgeBaseApiCore['readKnowledgeBaseSkillArchiveAttachment'];
let buildKnowledgeBasePrefillEvidenceArchive:KnowledgeBaseApiCore['buildKnowledgeBasePrefillEvidenceArchive'];
let buildKnowledgeBasePrompt:KnowledgeBaseApiCore['buildKnowledgeBasePrompt'];
let KnowledgeBaseEnterpriseIdentityError:KnowledgeBaseApiCore['KnowledgeBaseEnterpriseIdentityError'];
let KNOWLEDGE_BASE_PREFILL_ATTACHMENT_FILENAME:KnowledgeBaseApiCore['KNOWLEDGE_BASE_PREFILL_ATTACHMENT_FILENAME'];
let resolveKnowledgeBaseEnterpriseIdentity:KnowledgeBaseApiCore['resolveKnowledgeBaseEnterpriseIdentity'];
let buildKnowledgeBaseInstructionDelivery:KnowledgeBaseApiCore['buildKnowledgeBaseInstructionDelivery'];
let KNOWLEDGE_BASE_INSTRUCTIONS_FILENAME:KnowledgeBaseApiCore['KNOWLEDGE_BASE_INSTRUCTIONS_FILENAME'];
let buildKnowledgeBaseTurnPrompt:KnowledgeBaseApiCore['buildKnowledgeBaseTurnPrompt'];
let UpstreamPromptBudgetError:KnowledgeBaseApiCore['UpstreamPromptBudgetError'];
let UpstreamFileReadinessError:KnowledgeBaseApiCore['UpstreamFileReadinessError'];
let canonicalUpstreamTask:KnowledgeBaseApiCore['canonicalUpstreamTask'];
let upstreamTaskId:KnowledgeBaseApiCore['upstreamTaskId'];
let credentialForRequest:(request:Request)=>KnowledgeCredential|undefined;
let withCredentialScope:<T>(action:()=>T)=>T;
export function configureKnowledgeBaseApiCore(core:KnowledgeBaseApiCore) {
({knowledgeBaseBuildNodes}=core.tables);
({getKnowledgeImageLibrary,saveKnowledgeImageLibrary,acceptKnowledgeBaseInitialDraft,exportKnowledgeBaseWorkspace,runWithStoredEnterpriseProjectScope,sendAiBillingError,assertAiAccountFunds,assertKnowledgeBaseDispatchFunds,continueKnowledgeBaseAfterRecharge,pauseKnowledgeBaseForBilling,enterpriseWorkspaceUserId,knowledgeBaseWorkingSetAssetUrl,enterpriseProjectUrl,dispatchKnowledgeNodeEdit,dispatchManualKnowledgeNodeEdit,getKnowledgeNodeDetails,saveKnowledgeNodeContent,searchKnowledgeNodes,KNOWLEDGE_NODE_IMAGE_MIMES,createCredentialAgentClient,getUpstreamBaseUrl,AuthServiceError,getDecryptedCredentialForKnowledgeBaseReservation,getDecryptedCredentialForKnowledgeBaseUploadReservation,recordUpstreamResource,getDashboardWorkspace,getKnowledgeSnapshotById,getLatestKnowledgeSnapshot,downloadArchiveBytes,publishKnowledgeBaseBuild,KnowledgeArchiveDownloadError,assertServiceCapability,ServiceEntitlementError,getDb,UpstreamTaskAttachmentContentProofError,UpstreamTaskAttachmentPendingError,assertKnowledgeBaseWritable,parseExactJson,buildManusV2CreateTaskBody,latestManusV2TaskState,ManusV2ApiError,manusV2KnowledgeBaseStructuredResultForOperation,normalizeManusV2Output,orderManusV2EventsByProviderRank,ensureKnowledgeBaseManusV2Attachments,isKnowledgeBaseManusV2GeneratedFileCreateRejected,readStoredPresalesFile,persistKnowledgeBaseBuildSource,persistKnowledgeBaseGeneratedSource,readKnowledgeBaseLocalSource,ManagedUploadIntentError,logKnowledgeBaseRuntimeFailure,getKnowledgeBaseSkillDescriptor,knowledgeBasePinnedV4SkillSelection,readKnowledgeBaseSkillArchiveAttachment,buildKnowledgeBasePrefillEvidenceArchive,buildKnowledgeBasePrompt,KnowledgeBaseEnterpriseIdentityError,KNOWLEDGE_BASE_PREFILL_ATTACHMENT_FILENAME,resolveKnowledgeBaseEnterpriseIdentity,buildKnowledgeBaseInstructionDelivery,KNOWLEDGE_BASE_INSTRUCTIONS_FILENAME,buildKnowledgeBaseTurnPrompt,UpstreamPromptBudgetError,UpstreamFileReadinessError,canonicalUpstreamTask,upstreamTaskId, credentialForRequest,withCredentialScope}=core);
}
...
export * from "./knowledge-base-api-errors.js";

export * from "./knowledge-base-client-attachment-manifest.js";
export * from "./knowledge-base-turn-coordinates.js";
export {logKnowledgeBaseRuntimeFailure};
export * from "./knowledge-base-prompt-contract.js";
export { knowledgeBaseTurnLogoPolicy } from "./knowledge-base-deferred-attachment-stage-policy.js";
export {KNOWLEDGE_BASE_SKILL_ATTACHMENT_FILENAME,getKnowledgeBaseSkillDescriptor,knowledgeBasePinnedV4SkillSelection,readKnowledgeBaseSkillArchiveAttachment};
export {
  knowledgeBaseTurnRequiresFinalPackage,
  shouldBindKnowledgeBaseInitialLogo,
} from "./knowledge-base-final-turn-service.js";
export {buildKnowledgeBaseTurnPrompt};
...
router.use((req: KnowledgeRequest, res, next) => {
  const progressResponse = req.path.startsWith("/progress/");
  const responseFormat = progressResponse
    ? req.get(KNOWLEDGE_BASE_RESPONSE_HEADER)
    : undefined;
  if (progressResponse) {
    res.vary(KNOWLEDGE_BASE_RESPONSE_HEADER);
    res.setHeader("Cache-Control", "private, no-store");
  }
  const sendJson = res.json.bind(res);
  res.json = ((body: unknown) =>
    sendJson(toKnowledgeBasePublicPayload(
      knowledgeBaseProgressResponse(body, responseFormat),
    ))) as typeof res.json;
  next();
});
...
async function reconcileAvailableKnowledgeOutput(input: {
  ...
  artifactAccess?: { credentialRef: string; baseUrl: string };
}) {
        ...
        try {
          ...
          if (bindInitialLogo) {
            const logoBinding = await bindKnowledgeBaseInitialLogo({
              ...
              taskId: input.taskId,
              output: unreconciled,
              credentialRef: artifactAccess.credentialRef,
...
export function manusV2KnowledgeBaseAssistantProtocolFallback(input: {
  ...
  const candidates = input.events.flatMap((event: ManusV2MessageEvent) => {
...
export async function normalizeManusV2KnowledgeBaseOperationOutput(input: {
  ...
  return coreOutput.map((entry: unknown) => {
    ...
    try {
      void Promise.resolve(client.stopTask(taskId)).catch((error) => {
        logKnowledgeBaseRuntimeFailure({
          ...
          taskId,
          error,
          additionalSecrets: [credential.credentialRef],
        });
      });
    } catch (error) {
      logKnowledgeBaseRuntimeFailure({
...
export async function recoverExpiredKnowledgeBaseTurns(options?: {
  ...
  const worker = async () => {
    while (cursor < candidates.length) {
      ...
      let recoveryCredentialRef: string | undefined;
      try {
        ...
        recoveryCredentialRef = credential.credentialRef;
        const recovered = await withKnowledgeBaseRecoveryLeaseHeartbeat({
          claim: ownedClaim,
          operation: () =>
          ...
          if (terminalLogoFailure) {
            try {
              ...
              logKnowledgeBaseRuntimeFailure({
                ...
                additionalSecrets: [recoveryCredentialRef],
              });
            }
...
function launchAcceptedKnowledgeBaseClaim(input: {
  ...
  void dispatchAcceptedKnowledgeBaseClaim(input).catch(async (error) => {
    ...
    logKnowledgeBaseRuntimeFailure({
      ...
      turnId: input.claim.turn.id,
      error,
      additionalSecrets: [input.credential.credentialRef],
    });
  });
}
 ...
 */
router.post("/billing-resume", async (req: KnowledgeRequest, res) => {
...
router.post("/start/reserve", async (req: KnowledgeRequest, res) => {
  ...
  try {
    ...
    const start = await reserveKnowledgeBaseStartBuild({
      ...
      apiCredentialId: credentialForRequest(req)!.id,
      userText: "开始构建企业知识库",
 ...
 */
router.post("/start/cancel", async (req: KnowledgeRequest, res) => {
...
router.post("/confirm", async (req: KnowledgeRequest, res) => {
  ...
  let receipt: Awaited<ReturnType<typeof confirmMaterializedKnowledgeBaseNode>>;
  try {
    await assertKnowledgeBaseWritable(enterpriseWorkspaceUserId(req.frontmindUser.id));
    receipt = await confirmMaterializedKnowledgeBaseNode({
      userId: enterpriseWorkspaceUserId(req.frontmindUser.id),
      conversationId,
      clientRequestId,
      expectedGeneration,
  ...
  // Confirmation has committed. Publication and observation failures must
  // never turn that accepted confirmation into a failed/replayed turn.
  const acknowledgeConfirmation = async () => {
    ...
    if (!res.headersSent && !res.destroyed) {
      res.json({ ...receipt, ...(observation ? { observation } : {}) });
    }
  };
  if (receipt.disposition === "completed" && receipt.firstPublication) {
    try {
      await publishKnowledgeBaseBuild({
        userId: enterpriseWorkspaceUserId(req.frontmindUser.id),
        actorUserId: req.frontmindUser.id,
        conversationId,
        firstPublicationOnly: true,
        expectedBuildId: receipt.buildId,
        expectedGeneration: receipt.generation,
        expectedRevision: receipt.revision,
        expectedContentVersion: receipt.contentVersion,
        onClaimed: acknowledgeConfirmation,
      });
    } catch (error) {
      logKnowledgeBaseRuntimeFailure({
        level: "error",
        event: "[KnowledgeBaseInitialPublication] failed",
        userId: enterpriseWorkspaceUserId(req.frontmindUser.id),
        error,
      });
    }
  }
  await acknowledgeConfirmation().catch((error) => {
    logKnowledgeBaseRuntimeFailure({
      level: "error",
      event: "[KnowledgeBaseLocalConfirm] response_failed",
      userId: enterpriseWorkspaceUserId(req.frontmindUser!.id),
      error,
    });
  });
...
router.post("/initial-draft/accept", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
...
router.get("/workspace-export", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
...
router.get("/node/content", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
...
router.get("/node/search", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
...
router.post("/node/save", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
...
async function sendKnowledgeImageLibraryError(res: import("express").Response, error: unknown, userId: number, conversationId: unknown) {
  if (error instanceof z.ZodError) {
    res.status(400).json({ error: { code: "INVALID_REQUEST", message: "图片参数无效，每次最多上传 20 张图片" } });
    return;
  }
  if (error instanceof KnowledgeBaseMaterializedError && error.code === "INVALID_BUILD_STATE") {
    res.status(409).json({ error: { code: error.code, message: error.message } });
    return;
  }
  await sendKnowledgeNodeWorkspaceError(res, error, userId, conversationId);
}

router.get("/images", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
  try {
    const { enterpriseProjectId: _project, operatorOwnerId: _owner, ...query } = req.query;
    res.json(await getKnowledgeImageLibrary(userId, query));
  } catch (error) { await sendKnowledgeImageLibraryError(res, error, userId, req.query.conversationId); }
});

router.post("/images/save", async (req: KnowledgeRequest, res) => {
  res.setHeader("Cache-Control", "private, no-store");
  if (!req.frontmindUser) { res.status(401).json({ error: { code: "UNAUTHORIZED", message: "请先登录" } }); return; }
  const userId = enterpriseWorkspaceUserId(req.frontmindUser.id);
  if (!(await requireKnowledgeBuildCapability(userId, res))) return;
  try {
    await assertKnowledgeBaseWritable(userId);
    const receipt = await saveKnowledgeImageLibrary(userId, req.body);
    const observation = await getKnowledgeBaseObservation({ userId, conversationId: req.body.conversationId, upstreamStatus: "local" });
    if (!observation) throw new KnowledgeBaseMaterializedError("BUILD_NOT_FOUND", "知识库已重置，请重新读取");
    const library = await getKnowledgeImageLibrary(userId, { conversationId: req.body.conversationId });
    res.json({ ...receipt, observation, library });
  } catch (error) { await sendKnowledgeImageLibraryError(res, error, userId, req.body?.conversationId); }
});

router.get("/node/images", async (req: KnowledgeRequest, res) => {
  ...
  try {
    ...
    const manifest = active.workingSet.manifest as import("../contracts/knowledge-base-materialized-contract.js").KnowledgeBaseWorkingSetManifest;
...
router.post("/node/select", async (req: KnowledgeRequest, res) => {
  if (!req.frontmindUser || !(await requireKnowledgeBuildCapability(enterpriseWorkspaceUserId(req.frontmindUser.id), res))) return;
  const body = req.body ?? {};
...
router.post("/turn/reserve", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    clientRequestId?: string;
    userMessage?: string;
  ...
  try {
    ...
    const taskCredential = credentialForRequest(req)!;
    if (!taskCredential) {
...
router.post("/turn/upload-heartbeat", async (req: KnowledgeRequest, res) => {
...
router.post("/turn/attachments/resume", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    turnId?: string;
    clientRequestId?: string;
...
router.post("/turn/attachments/cancel", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    turnId?: string;
    clientRequestId?: string;
...
router.post("/turn/attachments/stage", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    turnId?: string;
    clientRequestId?: string;
...
router.post("/turn/dispatch", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    turnId?: string;
    clientRequestId?: string;
...
router.post("/turn", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    clientRequestId?: string;
    userMessage?: string;
        ...
        if (terminalLogoFailure) {
          ...
          try {
            ...
            logKnowledgeBaseRuntimeFailure({
              ...
              turnId: acceptedClaim.turn.id,
              error: persistenceError,
              additionalSecrets: [taskCredential.credentialRef],
            });
            await markKnowledgeBaseTurnOutcomeUnknown({
              userId: acceptedClaim.turn.userId,
              turnId: acceptedClaim.turn.id,
...
router.get("/progress/:conversationId", async (req: KnowledgeRequest, res) => {
  try {
    const observation = await getKnowledgeBaseObservation({
      userId: enterpriseWorkspaceUserId(req.frontmindUser!.id),
...
router.post("/progress/reconcile", async (req: KnowledgeRequest, res) => {
  const body = (req.body || {}) as {
    conversationId?: string;
    taskId?: string;
  };
