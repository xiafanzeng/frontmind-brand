...
import { classifyKnowledgeBaseUserAction } from "./knowledge-base-progress-service.js";
import {
...
import { buildKnowledgeBaseFinalizationInput } from "./knowledge-base-finalization-input.js";
import {
...
export interface KnowledgeServiceCore extends Pick<ReturnType<typeof createKnowledgeBuildArtifactStore>,"readKnowledgeBuildArtifact"> {knowledgeBaseBuildNodes:BrandSchema["knowledgeBaseBuildNodes"];knowledgeBaseBuilds:BrandSchema["knowledgeBaseBuilds"]; getDb():Promise<MySql2Database<any>|null>; enterpriseOwnerPredicate(table:any,userId:number):SQL;}
...
export function configureKnowledgeFinalTurn(core: KnowledgeServiceCore) { ({ enterpriseOwnerPredicate, knowledgeBaseBuildNodes, knowledgeBaseBuilds, getDb, readKnowledgeBuildArtifact } = core); }
