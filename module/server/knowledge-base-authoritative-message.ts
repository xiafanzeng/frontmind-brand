...
export interface KnowledgeMessageIdentityCore { enterpriseConversationStoragePrefix(userId:number):string; }
export function createKnowledgeBaseAuthoritativeMessages(core: KnowledgeMessageIdentityCore) {
const { enterpriseConversationStoragePrefix } = core;


function parsedKnowledgeBaseMessageMetadata(
 ...
 */
function matchesAuthoritativeKnowledgeBaseMessageTuple(input: {
...
return { parsedKnowledgeBaseMessageMetadata, knowledgeBasePresentationKey, matchesAuthoritativeKnowledgeBaseMessageTuple };
}
