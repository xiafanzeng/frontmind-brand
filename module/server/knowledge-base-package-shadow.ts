...
} from "@frontmind/module-brand/server/knowledge-package-projection";
import {
  finalizationSupplementCoverage,
  type FinalizationSupplementRecord,
} from "./knowledge-base-finalization-supplement.js";
import type {KnowledgeLocalSourceCore} from "./knowledge-base-local-source-store.js";
export interface KnowledgePackageStorageCore extends KnowledgeLocalSourceCore {}
let assetRoot: KnowledgePackageStorageCore["assetRoot"];
let installImmutableFileAtomically: KnowledgePackageStorageCore["installImmutableFileAtomically"];
export function configureKnowledgePackageShadow(core: KnowledgePackageStorageCore) { ({ installImmutableFileAtomically, assetRoot } = core); }
