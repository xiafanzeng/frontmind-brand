...
import {assertKnowledgeBasePackageMatchesBuild,KnowledgeBasePackageBindingError} from './knowledge-base-package-validation.js';
import {assertKnowledgeBaseCustomerUploadVisualBindings,declaredKnowledgeBaseCustomerUploadImagesFromTurn,knowledgeBaseCustomerUploadInternalIdentity,persistedKnowledgeBaseCustomerUploadBytesForBuild,readVerifiedKnowledgeBaseCustomerUploadImageBytes,type KnowledgeBaseCustomerUploadImage,verifiedKnowledgeBaseCustomerUploadImagesFromTurn,verifiedKnowledgeBasePackageUploadEvidenceForBuild} from './knowledge-base-customer-upload.js';
import {KnowledgeBuildArtifactError,type KnowledgeBuildArtifactKind} from './knowledge-build-artifact-store.js';
...
import {isDashboardOwnedKnowledgePackageBuild,readDashboardOwnedKnowledgePackage} from './knowledge-base-local-package.js';
import {KnowledgeBaseMaterializedAssetError} from './knowledge-base-materialized-assets.js';
type FrontMindRequest=KnowledgeRequest;
export interface KnowledgeBaseArtifactApiCore {
 tables:BrandSchema;
...
readStoredKnowledgeAssetBytes:Port;
validateKnowledgeArchiveForDownload:Port;
getDb:()=>Promise<MySql2Database<any>|null>;
knowledgeBuildArtifactStorageKeyBelongsTo:Port;
readKnowledgeBuildArtifact:Port;
readValidatedActiveKnowledgeBaseWorkingSet:Port;
resolveKnowledgeBaseWorkingSetResourceByOpaqueHandle:Port;
resolveKnowledgeBaseWorkingSetResource:Port;
knowledgeBaseOfficialLogoInternalIdentity:Port;
knowledgeBasePublicBuildSelectorMatches:Port;
knowledgeBasePublicResourceHandleMatches:Port;
parseKnowledgeBasePublicResourceHandle:Port;
}
let conversationTurns:CoreSqlTable<ConversationTurn>;
let knowledgeBaseBuildNodes:BrandSchema['knowledgeBaseBuildNodes'];
let knowledgeBaseBuilds:BrandSchema['knowledgeBaseBuilds'];
let enterpriseOwnerPredicate:KnowledgeBaseArtifactApiCore['enterpriseOwnerPredicate'];
let KnowledgeArchiveValidationError:KnowledgeBaseArtifactApiCore['KnowledgeArchiveValidationError'];
let readStoredKnowledgeAssetBytes:KnowledgeBaseArtifactApiCore['readStoredKnowledgeAssetBytes'];
let validateKnowledgeArchiveForDownload:KnowledgeBaseArtifactApiCore['validateKnowledgeArchiveForDownload'];
let getDb:KnowledgeBaseArtifactApiCore['getDb'];
let knowledgeBuildArtifactStorageKeyBelongsTo:KnowledgeBaseArtifactApiCore['knowledgeBuildArtifactStorageKeyBelongsTo'];
let readKnowledgeBuildArtifact:KnowledgeBaseArtifactApiCore['readKnowledgeBuildArtifact'];
let readValidatedActiveKnowledgeBaseWorkingSet:KnowledgeBaseArtifactApiCore['readValidatedActiveKnowledgeBaseWorkingSet'];
let resolveKnowledgeBaseWorkingSetResourceByOpaqueHandle:KnowledgeBaseArtifactApiCore['resolveKnowledgeBaseWorkingSetResourceByOpaqueHandle'];
let resolveKnowledgeBaseWorkingSetResource:KnowledgeBaseArtifactApiCore['resolveKnowledgeBaseWorkingSetResource'];
let knowledgeBaseOfficialLogoInternalIdentity:KnowledgeBaseArtifactApiCore['knowledgeBaseOfficialLogoInternalIdentity'];
let knowledgeBasePublicBuildSelectorMatches:KnowledgeBaseArtifactApiCore['knowledgeBasePublicBuildSelectorMatches'];
let knowledgeBasePublicResourceHandleMatches:KnowledgeBaseArtifactApiCore['knowledgeBasePublicResourceHandleMatches'];
let parseKnowledgeBasePublicResourceHandle:KnowledgeBaseArtifactApiCore['parseKnowledgeBasePublicResourceHandle'];
export function configureKnowledgeBaseArtifactApiCore(core:KnowledgeBaseArtifactApiCore) {
({knowledgeBaseBuildNodes,knowledgeBaseBuilds}=core.tables);
({enterpriseOwnerPredicate,KnowledgeArchiveValidationError,readStoredKnowledgeAssetBytes,validateKnowledgeArchiveForDownload,getDb,knowledgeBuildArtifactStorageKeyBelongsTo,readKnowledgeBuildArtifact,readValidatedActiveKnowledgeBaseWorkingSet,resolveKnowledgeBaseWorkingSetResourceByOpaqueHandle,resolveKnowledgeBaseWorkingSetResource,knowledgeBaseOfficialLogoInternalIdentity,knowledgeBasePublicBuildSelectorMatches,knowledgeBasePublicResourceHandleMatches,parseKnowledgeBasePublicResourceHandle,conversationTurns}=core);
}
      ...
      if (isDashboardOwnedKnowledgePackageBuild(build)) {
        ...
        await validateKnowledgeArchiveForDownload({
          ...
          ...(build.skillVersion === "3" || build.skillVersion === "4"
            ? {
                validateParsed: async (parsed: any) => {
                  if (
