...
import { z } from "zod";
import type { KnowledgeAsset, KnowledgeDocument } from "@frontmind/module-brand/contracts/dashboard-types";
import {
  customerSafeKnowledgeFilename,
  customerSafeKnowledgeText,
  customerSafeKnowledgeUrls,
} from "./knowledge-base-public-artifacts.js";
import {
  canonicalKnowledgeBaseMarkdown,
  knowledgeBaseMarkdownSha256,
} from "./knowledge-base-package-validation.js";
import type { ValidatedKnowledgeBaseWorkingSet } from "../contracts/knowledge-base-materialized-contract.js";
...
export interface KnowledgeMaterializationCore extends Pick<ReturnType<typeof createKnowledgeBuildArtifactStore>, "knowledgeBuildArtifactLocalPackageStorageKey"|"persistKnowledgeBuildArtifact"|"readKnowledgeBuildArtifact">,Pick<ReturnType<typeof createKnowledgeBaseMaterializedAssets>, "readValidatedActiveKnowledgeBaseWorkingSet"> {
 getDb():Promise<MySql2Database<any>|null>; enterpriseOwnerPredicate(table:any,userId:number):SQL;
 knowledgeBaseBuildNodes:BrandSchema["knowledgeBaseBuildNodes"];knowledgeBaseBuilds:BrandSchema["knowledgeBaseBuilds"];}
...
let knowledgeBuildArtifactLocalPackageStorageKey: KnowledgeMaterializationCore["knowledgeBuildArtifactLocalPackageStorageKey"];
...
let readValidatedActiveKnowledgeBaseWorkingSet: KnowledgeMaterializationCore["readValidatedActiveKnowledgeBaseWorkingSet"];
export function configureKnowledgeBaseLocalPackage(core: KnowledgeMaterializationCore) { ({ enterpriseOwnerPredicate, knowledgeBaseBuildNodes, knowledgeBaseBuilds, getDb, knowledgeBuildArtifactLocalPackageStorageKey, persistKnowledgeBuildArtifact, readKnowledgeBuildArtifact, readValidatedActiveKnowledgeBaseWorkingSet } = core); }
...
/** Called by first publication or an explicit update, never by node edits or a timer. */
