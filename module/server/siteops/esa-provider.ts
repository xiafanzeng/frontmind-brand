import {siteOpsRevisionLineageFromRows} from "./manus-provider.js";
...
let createEsaDirectApi:EsaProviderCore['createEsaDirectApi'];
let enterpriseSiteProfileTable:EsaProviderCore['enterpriseSiteProfileTable'];
let enterpriseSiteProfileOwnerPredicate:EsaProviderCore['enterpriseSiteProfileOwnerPredicate'];
let enterpriseOwnerPredicate:EsaProviderCore['enterpriseOwnerPredicate'];
let runtimeErrorForLog:EsaProviderCore['runtimeErrorForLog'];
let getDb:EsaProviderCore['getDb'];
let persistSiteOpsArtifact:EsaProviderCore['persistSiteOpsArtifact'];
let readSiteOpsArtifact:EsaProviderCore['readSiteOpsArtifact'];
let inspectEsaRuntimeConfiguration:EsaProviderCore['inspectEsaRuntimeConfiguration'];
export function configureEsaProviderCore(core:EsaProviderCore){
 ({knowledgeBaseSnapshots,siteBuilds,siteBuildInputAssets,siteDeployments,siteDnsRecords,siteOperations,siteProjects,websiteStyleSampleBatches}=core.tables);
 ({createEsaDirectApi,enterpriseSiteProfileTable,enterpriseSiteProfileOwnerPredicate,enterpriseOwnerPredicate,runtimeErrorForLog,getDb,persistSiteOpsArtifact,readSiteOpsArtifact,inspectEsaRuntimeConfiguration,messages}=core);
}
...
import { buildContractV2Schema } from "../../contracts/siteops-design.js";
import {
  siteContentPlanV2Schema,
  type SiteContentPlanV2,
} from "../../contracts/siteops-content-plan.js";
import { canonicalJson } from "../../contracts/siteops-workflow.js";




import { materializeProductionSiteFromSource } from "./build-runtime.js";

import { fetchPinnedPublicHttps } from "./remote-preview.js";

import { rebuildNativeReactProductionFromSource } from "./native-react-build-runtime.js";
import { validateNativeReactSourceArchive } from "./native-react-source.js";
import {
