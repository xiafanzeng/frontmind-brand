...
export interface RestartServiceCore {
 tables:BrandSchema;
 messages:any;
...
let enterpriseOwnerPredicate:RestartServiceCore['enterpriseOwnerPredicate'];
export function configureRestartServiceCore(core:RestartServiceCore){
 ({siteBuilds,siteOperations,siteProjects,socialPackages,visualCandidatePoolPages,visualCandidatePools,websiteStyleSampleBatches}=core.tables);
 ({enterpriseOwnerPredicate,messages}=core);
}
