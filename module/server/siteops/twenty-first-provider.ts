...
type KnowledgeBaseSnapshot=BrandSchema['knowledgeBaseSnapshots']['$inferSelect'];
type SiteOperation=BrandSchema['siteOperations']['$inferSelect'];
type SiteProject=BrandSchema['siteProjects']['$inferSelect'];
  import type {TwentyFirstClient as TwentyFirstClientPort,TwentyFirstNativeTemplateSummary,TwentyFirstReadOnlySession} from './provider-ports.js';
type TwentyFirstClient=TwentyFirstClientPort;
export interface TwentyFirstProviderCore {
 tables:BrandSchema;
 messages:any;
 TwentyFirstClient:new ()=>TwentyFirstClientPort;
 getSiteOpsTwentyFirstCredential:(id:string)=>Promise<{id:string;version:number;credentialRef:string}|null>;
 ...
 TwentyFirstNativeTemplateError:new (...args:any[])=>Error & {code:string;category:"catalog_unavailable"|"plan_ineligible"|"download_unavailable";retryable:boolean};
 TwentyFirstToolContractError:new (...args:any[])=>Error & {code:string};
...
let visualCandidatePoolItems:BrandSchema['visualCandidatePoolItems'];
...
let TwentyFirstClient:TwentyFirstProviderCore['TwentyFirstClient'];
let getSiteOpsTwentyFirstCredential:TwentyFirstProviderCore['getSiteOpsTwentyFirstCredential'];
let resolveNativeTemplateShuffleKey:TwentyFirstProviderCore['resolveNativeTemplateShuffleKey'];
let enterpriseOwnerPredicate:TwentyFirstProviderCore['enterpriseOwnerPredicate'];
let AuthServiceError:TwentyFirstProviderCore['AuthServiceError'];
let getDb:TwentyFirstProviderCore['getDb'];
let TwentyFirstNativeTemplateError:TwentyFirstProviderCore['TwentyFirstNativeTemplateError'];
let TwentyFirstToolContractError:TwentyFirstProviderCore['TwentyFirstToolContractError'];
let persistSiteOpsArtifact:TwentyFirstProviderCore['persistSiteOpsArtifact'];
let readSiteOpsArtifact:TwentyFirstProviderCore['readSiteOpsArtifact'];
export function configureTwentyFirstProviderCore(core:TwentyFirstProviderCore){
 ({knowledgeBaseSnapshots,siteOperations,siteProjects,visualCandidatePoolItems,visualCandidatePoolPages,visualCandidatePools,websiteStyleSampleBatches,websiteStyleSamples}=core.tables);
 ({TwentyFirstClient,getSiteOpsTwentyFirstCredential,resolveNativeTemplateShuffleKey,enterpriseOwnerPredicate,AuthServiceError,getDb,TwentyFirstNativeTemplateError,TwentyFirstToolContractError,persistSiteOpsArtifact,readSiteOpsArtifact,messages}=core);
}
...
import { registerSiteOpsProviderHandler } from "./providers.js";
import { fetchSafeVisualPreview } from "./remote-preview.js";
import { renderTrustedVisualCandidatePreviews } from "./react-static-runtime.js";
import type {
...
export type TwentyFirstProviderDependencies = {
  ...
  getCredential?: typeof getSiteOpsTwentyFirstCredential;
...
async function runNativeTemplateVisualSearch(input: {
  ...
  try {
    ...
    catalog = await input.client.listNativeTemplates(input.credentialRef, {
    ...
    const results = await Promise.all(
      batch.map(async (summary) => {
        ...
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            archive = await input.client.downloadNativeTemplate(input.credentialRef, {
...
export function createTwentyFirstSiteOpsProviderHandler(
  ...
  const getCredential =
    dependencies.getCredential ?? getSiteOpsTwentyFirstCredential;
