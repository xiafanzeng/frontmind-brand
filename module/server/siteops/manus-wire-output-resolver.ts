...
export interface ManusWireOutputResolverCore {
 tables:BrandSchema;
...
let classifyManusV2StructuredResultEnvelope:ManusWireOutputResolverCore['classifyManusV2StructuredResultEnvelope'];
let manusV2EventOperationToken:ManusWireOutputResolverCore['manusV2EventOperationToken'];
let orderManusV2EventsByProviderRank:ManusWireOutputResolverCore['orderManusV2EventsByProviderRank'];
export function configureManusWireOutputResolverCore(core:ManusWireOutputResolverCore){
 ({}=core.tables);
 ({classifyManusV2StructuredResultEnvelope,manusV2EventOperationToken,orderManusV2EventsByProviderRank}=core);
}
import { createHash } from "node:crypto";

import { SITEOPS_CONTENT_PLAN_V2_FILENAME } from "../../contracts/siteops-content-plan.js";
