import {restartSiteOpsProject,siteOpsRestartState,SiteOpsRestartError} from "./restart-service.js";
import {customerVisibleStyleBatchStatusCondition} from "./visual-batch-visibility.js";
...
export type SiteOpsQuotaError=Error & {code:string;statusCode:number};
export interface SiteOpsServiceCore {
 tables:BrandSchema;
 conversations:any;conversationTurns:any;localAssets:any;
 messages:any;
 readSiteOpsCredentialReadiness:Port;
 lockSiteOpsIdentity:Port;
 readActiveSiteOpsProviderCredential:Port;
 readActiveSiteOpsAiCredential:Port;
 readPinnedSiteOpsProviderCredential:Port;
 assertSiteOpsActor:Port;
 lockCustomerProjectBusinessWrite:Port;
 enterpriseWorkspaceUserId:Port;
 getEnterpriseProjectScope:Port;
 enterpriseAccountOwnerPredicate:(...args:any[])=>SQL;
 enterpriseSiteProfileTable:Port;
 enterpriseSiteProfileOwnerPredicate:(...args:any[])=>SQL;
 enterpriseOwnerPredicate:(...args:any[])=>SQL;
 enterpriseProjectUrl:Port;
 runWithSiteOpsOAuthProjectScope:Port;
 AuthServiceError:new (...args:any[])=>Error & {code:string};
 credentialProfileProjection:Port;
 getDb:()=>Promise<MySql2Database<any>|null>;
 ownedFileContentResolver:any;
 getServicePortal:Port;
 getTwentyFirstCredentialStatus:Port;
 AliyunProviderError:new (...args:any[])=>Error & {code:string};
 bindAliyunCustomerAccountFromOAuth:Port;
 disconnectAliyunCustomerConnection:Port;
 getAliyunCustomerConnectionStatus:Port;
 listAliyunCustomerDomains:Port;
 createAliyunOAuthAuthorization:Port;
 inspectEsaRuntimeConfiguration:Port;
 assertSiteOpsServiceEntitlement:Port;
 reserveSiteOpsQuota:Port;
 siteOpsQuotaPeriodIds:Port;
 SiteOpsQuotaError:new (...args:any[])=>Error & {code:string;statusCode:number};
 persistSiteOpsArtifact:Port;
}
...
let localAssets:any;
let messages:any;
let siteBuildInputAssets:BrandSchema['siteBuildInputAssets'];
let siteBuilds:BrandSchema['siteBuilds'];
let siteDeployments:BrandSchema['siteDeployments'];
let siteDnsRecords:BrandSchema['siteDnsRecords'];
let siteOperations:BrandSchema['siteOperations'];
let siteProjects:BrandSchema['siteProjects'];
let siteProviderConnections:BrandSchema['siteProviderConnections'];
let socialPackages:BrandSchema['socialPackages'];
let visualCandidatePoolPages:BrandSchema['visualCandidatePoolPages'];
let visualCandidatePools:BrandSchema['visualCandidatePools'];
let websiteStyleSampleBatches:BrandSchema['websiteStyleSampleBatches'];
let websiteStyleSamples:BrandSchema['websiteStyleSamples'];
let readSiteOpsCredentialReadiness:SiteOpsServiceCore['readSiteOpsCredentialReadiness'];
let lockSiteOpsIdentity:SiteOpsServiceCore['lockSiteOpsIdentity'];
let readActiveSiteOpsProviderCredential:SiteOpsServiceCore['readActiveSiteOpsProviderCredential'];
let readActiveSiteOpsAiCredential:SiteOpsServiceCore['readActiveSiteOpsAiCredential'];
let readPinnedSiteOpsProviderCredential:SiteOpsServiceCore['readPinnedSiteOpsProviderCredential'];
let assertSiteOpsActor:SiteOpsServiceCore['assertSiteOpsActor'];
let lockCustomerProjectBusinessWrite:SiteOpsServiceCore['lockCustomerProjectBusinessWrite'];
let enterpriseWorkspaceUserId:SiteOpsServiceCore['enterpriseWorkspaceUserId'];
let getEnterpriseProjectScope:SiteOpsServiceCore['getEnterpriseProjectScope'];
let enterpriseAccountOwnerPredicate:SiteOpsServiceCore['enterpriseAccountOwnerPredicate'];
let enterpriseSiteProfileTable:SiteOpsServiceCore['enterpriseSiteProfileTable'];
let enterpriseSiteProfileOwnerPredicate:SiteOpsServiceCore['enterpriseSiteProfileOwnerPredicate'];
let enterpriseOwnerPredicate:SiteOpsServiceCore['enterpriseOwnerPredicate'];
let enterpriseProjectUrl:SiteOpsServiceCore['enterpriseProjectUrl'];
let runWithSiteOpsOAuthProjectScope:SiteOpsServiceCore['runWithSiteOpsOAuthProjectScope'];
let AuthServiceError:SiteOpsServiceCore['AuthServiceError'];
let credentialProfileProjection:SiteOpsServiceCore['credentialProfileProjection'];
let getDb:SiteOpsServiceCore['getDb'];
let ownedFileContentResolver:SiteOpsServiceCore['ownedFileContentResolver'];
let getServicePortal:SiteOpsServiceCore['getServicePortal'];
let getTwentyFirstCredentialStatus:SiteOpsServiceCore['getTwentyFirstCredentialStatus'];
let AliyunProviderError:SiteOpsServiceCore['AliyunProviderError'];
let bindAliyunCustomerAccountFromOAuth:SiteOpsServiceCore['bindAliyunCustomerAccountFromOAuth'];
let disconnectAliyunCustomerConnection:SiteOpsServiceCore['disconnectAliyunCustomerConnection'];
let getAliyunCustomerConnectionStatus:SiteOpsServiceCore['getAliyunCustomerConnectionStatus'];
let listAliyunCustomerDomains:SiteOpsServiceCore['listAliyunCustomerDomains'];
let createAliyunOAuthAuthorization:SiteOpsServiceCore['createAliyunOAuthAuthorization'];
let inspectEsaRuntimeConfiguration:SiteOpsServiceCore['inspectEsaRuntimeConfiguration'];
let assertSiteOpsServiceEntitlement:SiteOpsServiceCore['assertSiteOpsServiceEntitlement'];
let reserveSiteOpsQuota:SiteOpsServiceCore['reserveSiteOpsQuota'];
let siteOpsQuotaPeriodIds:SiteOpsServiceCore['siteOpsQuotaPeriodIds'];
let SiteOpsQuotaError:SiteOpsServiceCore['SiteOpsQuotaError'];
let persistSiteOpsArtifact:SiteOpsServiceCore['persistSiteOpsArtifact'];
export function configureSiteOpsServiceCore(core:SiteOpsServiceCore){
 ({knowledgeBaseSnapshots,siteBuildInputAssets,siteBuilds,siteDeployments,siteDnsRecords,siteOperations,siteProjects,siteProviderConnections,socialPackages,visualCandidatePoolPages,visualCandidatePools,websiteStyleSampleBatches,websiteStyleSamples}=core.tables);
 ({readSiteOpsCredentialReadiness,lockSiteOpsIdentity,readActiveSiteOpsProviderCredential,readActiveSiteOpsAiCredential,readPinnedSiteOpsProviderCredential,assertSiteOpsActor,lockCustomerProjectBusinessWrite,enterpriseWorkspaceUserId,getEnterpriseProjectScope,enterpriseAccountOwnerPredicate,enterpriseSiteProfileTable,enterpriseSiteProfileOwnerPredicate,enterpriseOwnerPredicate,enterpriseProjectUrl,runWithSiteOpsOAuthProjectScope,AuthServiceError,credentialProfileProjection,getDb,ownedFileContentResolver,getServicePortal,getTwentyFirstCredentialStatus,AliyunProviderError,bindAliyunCustomerAccountFromOAuth,disconnectAliyunCustomerConnection,getAliyunCustomerConnectionStatus,listAliyunCustomerDomains,createAliyunOAuthAuthorization,inspectEsaRuntimeConfiguration,assertSiteOpsServiceEntitlement,reserveSiteOpsQuota,siteOpsQuotaPeriodIds,SiteOpsQuotaError,persistSiteOpsArtifact,messages,conversations,conversationTurns,localAssets}=core);
}
...
import {
  ...
  type SiteBrief,
} from "../../contracts/siteops.js";
import { SITEOPS_CUSTOMER_DISPLAY_NAME } from "../../contracts/siteops-branding.js";
import { createVisualEvidenceV1 } from "../../contracts/siteops-workflow.js";
import {
...
} from "../../contracts/siteops-contract.js";
import {
...
} from "../../contracts/siteops-design.js";
import {
...
import { siteOpsTrustedFallbackPreviewFromResult } from "./trusted-fallback.js";
import {
...
} from "../knowledge-archive-image-validation.js";
...
function assertCustomer(actor: AuthenticatedUser) { assertSiteOpsActor(actor); }
...
async function loadServiceReadiness(
  ...
  const {platformCredentials,aiBuilderCredentials}=await readSiteOpsCredentialReadiness(executor,input.userId);
...
export async function openSiteOps(actor: AuthenticatedUser) {
  ...
  const project = await db.transaction(async (tx: any) => {
    ...
    await lockSiteOpsIdentity(tx,enterpriseWorkspaceUserId(actor.id));
...
async function ensureActiveProviderCredential(
  ...
  const rows=await readActiveSiteOpsProviderCredential(tx,slot);
  const row = rows[0];
  if (!row) {
    throw new SiteOpsServiceError(
      "PROVIDER_NOT_CONFIGURED",
...
async function ensureActiveCustomerAiCredential(tx: any, userId: number) {
  const rows=await readActiveSiteOpsAiCredential(tx,userId);
  const row = rows[0];
  if (!row) {
    throw new SiteOpsServiceError(
      "PROVIDER_NOT_CONFIGURED",
...
export async function resolvePinnedTwentyFirstCredentialForBatch(
  ...
  const credentialRows=await readPinnedSiteOpsProviderCredential(tx,frozen.data.credentialId);
...
async function handleSelectSnapshot(
  ...
  const lockedUsers = await lockSiteOpsIdentity(tx,enterpriseWorkspaceUserId(input.actor.id));
  if (!lockedUsers[0]) {
    throw new SiteOpsServiceError(
      "NOT_FOUND",
      "当前账号不可用，请刷新后重新登录。",
