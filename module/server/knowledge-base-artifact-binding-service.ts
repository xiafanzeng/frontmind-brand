...
} from "./knowledge-base-package-canonicalization.js";
import {
...
} from "./knowledge-base-progress-service.js";
import {
...
} from "./knowledge-base-archive-contract.js";
import { runKnowledgePackageLiveShadow } from "./knowledge-base-package-shadow-live.js";
...
import {KnowledgeBuildArtifactError} from "./knowledge-build-artifact-store.js";

export interface KnowledgeArchiveReadResult { documents:KnowledgeDocument[];assets:KnowledgeAsset[];storedAssetKeys:string[];validationProfile?:"historical"|"dashboard-enterprise-v1"|"website-lead-v1";packageBuildRevision?:number;packageSchemaVersion?:1|2|3|4;packageManifestSha256?:string; }
export interface KnowledgeArtifactBindingCore extends Pick<ReturnType<typeof createKnowledgeBuildArtifactStore>, "persistKnowledgeBuildArtifact"|"listStaleKnowledgeBuildArtifactCandidates"|"readKnowledgeBuildArtifact"|"removeKnowledgeBuildArtifact"|"removeStagedKnowledgeBuildArtifact"|"stageKnowledgeBuildArtifact"|"knowledgeBuildArtifactStorageKey"|"knowledgeBuildArtifactCandidateStorageKey"|"knowledgeBuildArtifactLocalPackageStorageKey"> {
 conversationTurns:CoreSqlTable<ConversationTurn>; knowledgeBaseBuildNodes:BrandSchema["knowledgeBaseBuildNodes"];knowledgeBaseBuilds:BrandSchema["knowledgeBaseBuilds"];
 enterpriseOwnerPredicate(table:any,userId:number):SQL;getDb():Promise<MySql2Database<any>|null>;
 assertSafeExternalUrl(value:string):string;safeExternalRequestOptions:AxiosRequestConfig;
 downloadArchiveBytes(input:{descriptor:KnowledgeArchiveDescriptor;credentialRef:string;baseUrl:string}):Promise<{buffer:Buffer;filename:string}>;
 KnowledgeArchiveValidationError: new (...args:any[])=>Error;
 readKnowledgeArchive(buffer:Buffer,filename:string,snapshotId:string,options?:{validationProfile?:"historical"|"dashboard-enterprise-v1"|"website-lead-v1";archiveContractVersion?:1|2|3|4;archiveContractVersions?:readonly (1|2|3|4)[];allowV4CustomerVisibleCharacterCountRepair?:boolean;dashboardEnterpriseMinLeaves?:number;requireDashboardAdaptiveFormalGate?:boolean}):Promise<KnowledgeArchiveReadResult>;
 readStoredKnowledgeAssetBytes(key:string):Promise<Buffer>;removeStoredKnowledgeAssets(keys:string[]):Promise<void>;
...
let enterpriseOwnerPredicate: KnowledgeArtifactBindingCore["enterpriseOwnerPredicate"];
let conversationTurns: KnowledgeArtifactBindingCore["conversationTurns"];
let knowledgeBaseBuildNodes: KnowledgeArtifactBindingCore["knowledgeBaseBuildNodes"];
let knowledgeBaseBuilds: KnowledgeArtifactBindingCore["knowledgeBaseBuilds"];
let assertSafeExternalUrl: KnowledgeArtifactBindingCore["assertSafeExternalUrl"];
let safeExternalRequestOptions: KnowledgeArtifactBindingCore["safeExternalRequestOptions"];
let getDb: KnowledgeArtifactBindingCore["getDb"];
let downloadArchiveBytes: KnowledgeArtifactBindingCore["downloadArchiveBytes"];
let KnowledgeArchiveValidationError: KnowledgeArtifactBindingCore["KnowledgeArchiveValidationError"];
let readKnowledgeArchive: KnowledgeArtifactBindingCore["readKnowledgeArchive"];
let readStoredKnowledgeAssetBytes: KnowledgeArtifactBindingCore["readStoredKnowledgeAssetBytes"];
let removeStoredKnowledgeAssets: KnowledgeArtifactBindingCore["removeStoredKnowledgeAssets"];
let persistKnowledgeBuildArtifact: KnowledgeArtifactBindingCore["persistKnowledgeBuildArtifact"];
let listStaleKnowledgeBuildArtifactCandidates: KnowledgeArtifactBindingCore["listStaleKnowledgeBuildArtifactCandidates"];
let readKnowledgeBuildArtifact: KnowledgeArtifactBindingCore["readKnowledgeBuildArtifact"];
let removeKnowledgeBuildArtifact: KnowledgeArtifactBindingCore["removeKnowledgeBuildArtifact"];
let removeStagedKnowledgeBuildArtifact: KnowledgeArtifactBindingCore["removeStagedKnowledgeBuildArtifact"];
let stageKnowledgeBuildArtifact: KnowledgeArtifactBindingCore["stageKnowledgeBuildArtifact"];
let readStoredPresalesFile: KnowledgeArtifactBindingCore["readStoredPresalesFile"];
export function configureKnowledgeArtifactBinding(core: KnowledgeArtifactBindingCore) { ({ enterpriseOwnerPredicate, conversationTurns, knowledgeBaseBuildNodes, knowledgeBaseBuilds, assertSafeExternalUrl, safeExternalRequestOptions, getDb, downloadArchiveBytes, KnowledgeArchiveValidationError, readKnowledgeArchive, readStoredKnowledgeAssetBytes, removeStoredKnowledgeAssets, persistKnowledgeBuildArtifact, listStaleKnowledgeBuildArtifactCandidates, readKnowledgeBuildArtifact, removeKnowledgeBuildArtifact, removeStagedKnowledgeBuildArtifact, stageKnowledgeBuildArtifact, readStoredPresalesFile } = core); }
