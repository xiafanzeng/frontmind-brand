...
} from "@frontmind/module-contracts/provider-diagnostics";
import type { KnowledgeBaseTreePolicyVersion } from "../contracts/knowledge-base-progress.js";
import {
  knowledgeBaseNewBuildPolicyBinding,
  KNOWLEDGE_BASE_MATERIALIZED_V5_SKILL_CONTENT_HASH,
} from "./knowledge-base-tree-policy-rollout.js";
...
import { knowledgeBaseLocalAssetIdentity } from "./knowledge-base-local-asset-upload.js";
import {
...
} from "./knowledge-base-materialized-completion-contract.js";
import {
...
import type {BrandSchema, KnowledgeBaseBuild} from "../schema/index.js";
import type {CoreSqlTable} from "../contracts/sql-table.js";
import type {Conversation, ConversationTurn, LocalAsset, Message, ProviderFileLease, UpstreamResource} from "../contracts/core-records.js";
...
export interface KnowledgeTurnCore extends Pick<ReturnType<typeof createKnowledgeWorkbenchStages>, "knowledgeWorkbenchEditingAllowed">, Pick<ReturnType<typeof createKnowledgeBaseConversationMessages>, "markKnowledgeBaseConversationAwaitingInputInTransaction" | "markKnowledgeBaseConversationFailedInTransaction" | "persistKnowledgeBaseUserMessageInTransaction">, Pick<ReturnType<typeof createKnowledgeBaseLocalSourceStore>, "persistKnowledgeBaseBuildSource" | "readKnowledgeBaseLocalSource">, Pick<ReturnType<typeof createKnowledgeBaseSkillRuntime>, "readKnowledgeBasePinnedSkillArchiveAttachment">, Pick<ReturnType<typeof createKnowledgeBaseAuthoritativeMessages>, "matchesAuthoritativeKnowledgeBaseMessageTuple" | "parsedKnowledgeBaseMessageMetadata"> {
  tables: {
  ...
  knowledgeBaseConversationTombstones: BrandSchema["knowledgeBaseConversationTombstones"];
  localAssets: CoreSqlTable<LocalAsset>;
  messages: CoreSqlTable<Message>;
  providerFileLeases: CoreSqlTable<ProviderFileLease>;
  upstreamResources: CoreSqlTable<UpstreamResource>;
  };
  getDb():Promise<MySql2Database<any> | null>;
  AuthServiceError: new (code:"DATABASE_UNAVAILABLE",message:string) => Error & { code:string };
  lockCustomerProjectBusinessWrite(tx:any,ownerUserId:number):Promise<void>;
  ...
  knowledgeBaseSessionStorageId(userId:number,conversationId:string):string;
...
let knowledgeWorkbenchEditingAllowed: KnowledgeTurnCore["knowledgeWorkbenchEditingAllowed"];
let enterpriseAccountOwnerPredicate: KnowledgeTurnCore["enterpriseAccountOwnerPredicate"];
let knowledgeBaseSessionStorageId: KnowledgeTurnCore["knowledgeBaseSessionStorageId"];
let enterpriseConversationStoragePrefix: KnowledgeTurnCore["enterpriseConversationStoragePrefix"];
let enterpriseResetStateTable: KnowledgeTurnCore["enterpriseResetStateTable"];
let enterpriseResetStateOwnerPredicate: KnowledgeTurnCore["enterpriseResetStateOwnerPredicate"];
let enterpriseOwnerPredicate: KnowledgeTurnCore["enterpriseOwnerPredicate"];
let enterpriseProjectIdForOwner: KnowledgeTurnCore["enterpriseProjectIdForOwner"];
let AuthServiceError: KnowledgeTurnCore["AuthServiceError"];
let markKnowledgeBaseConversationAwaitingInputInTransaction: KnowledgeTurnCore["markKnowledgeBaseConversationAwaitingInputInTransaction"];
let markKnowledgeBaseConversationFailedInTransaction: KnowledgeTurnCore["markKnowledgeBaseConversationFailedInTransaction"];
let persistKnowledgeBaseUserMessageInTransaction: KnowledgeTurnCore["persistKnowledgeBaseUserMessageInTransaction"];
let getDb: KnowledgeTurnCore["getDb"];
let persistKnowledgeBaseBuildSource: KnowledgeTurnCore["persistKnowledgeBaseBuildSource"];
let readKnowledgeBaseLocalSource: KnowledgeTurnCore["readKnowledgeBaseLocalSource"];
let readStoredPresalesFile: KnowledgeTurnCore["readStoredPresalesFile"];
let readKnowledgeBasePinnedSkillArchiveAttachment: KnowledgeTurnCore["readKnowledgeBasePinnedSkillArchiveAttachment"];
let matchesAuthoritativeKnowledgeBaseMessageTuple: KnowledgeTurnCore["matchesAuthoritativeKnowledgeBaseMessageTuple"];
let parsedKnowledgeBaseMessageMetadata: KnowledgeTurnCore["parsedKnowledgeBaseMessageMetadata"];
let lockKnowledgeBaseReservationCredential: KnowledgeTurnCore["lockKnowledgeBaseReservationCredential"];
let readCredentialVersion: KnowledgeTurnCore["readCredentialVersion"];
let conversations: KnowledgeTurnCore["tables"]["conversations"];
let conversationTurns: KnowledgeTurnCore["tables"]["conversationTurns"];
let knowledgeBaseSnapshots: KnowledgeTurnCore["tables"]["knowledgeBaseSnapshots"];
let knowledgeBaseBuildNodes: KnowledgeTurnCore["tables"]["knowledgeBaseBuildNodes"];
let knowledgeBaseBuilds: KnowledgeTurnCore["tables"]["knowledgeBaseBuilds"];
let knowledgeBaseWorkingSets: KnowledgeTurnCore["tables"]["knowledgeBaseWorkingSets"];
let knowledgeBaseConversationRetentionTombstones: KnowledgeTurnCore["tables"]["knowledgeBaseConversationRetentionTombstones"];
let knowledgeBaseConversationTombstones: KnowledgeTurnCore["tables"]["knowledgeBaseConversationTombstones"];
let localAssets: KnowledgeTurnCore["tables"]["localAssets"];
let messages: KnowledgeTurnCore["tables"]["messages"];
let providerFileLeases: KnowledgeTurnCore["tables"]["providerFileLeases"];
let upstreamResources: KnowledgeTurnCore["tables"]["upstreamResources"];
/** Configured once by the private host; scoped operations still use Core's request-local context. */
export function configureKnowledgeBaseTurns(core:KnowledgeTurnCore) {
 ({ lockCustomerProjectBusinessWrite, knowledgeWorkbenchEditingAllowed, enterpriseAccountOwnerPredicate, knowledgeBaseSessionStorageId, enterpriseConversationStoragePrefix, enterpriseResetStateTable, enterpriseResetStateOwnerPredicate, enterpriseOwnerPredicate, enterpriseProjectIdForOwner, AuthServiceError, markKnowledgeBaseConversationAwaitingInputInTransaction, markKnowledgeBaseConversationFailedInTransaction, persistKnowledgeBaseUserMessageInTransaction, getDb, persistKnowledgeBaseBuildSource, readKnowledgeBaseLocalSource, readStoredPresalesFile, readKnowledgeBasePinnedSkillArchiveAttachment, matchesAuthoritativeKnowledgeBaseMessageTuple, parsedKnowledgeBaseMessageMetadata, lockKnowledgeBaseReservationCredential, readCredentialVersion } = core);
 ({ conversations, conversationTurns, knowledgeBaseSnapshots, knowledgeBaseBuildNodes, knowledgeBaseBuilds, knowledgeBaseWorkingSets, knowledgeBaseConversationRetentionTombstones, knowledgeBaseConversationTombstones, localAssets, messages, providerFileLeases, upstreamResources } = core.tables);
}
...
type ReadUploadObservation = (tx: any) => Promise<import("../contracts/knowledge-base-public-progress.js").KnowledgeBaseObservationDto | null>;
...
export async function persistKnowledgeBaseManusV2AttachmentMapping(
  ...
  return db.transaction(async (tx: any) => {
    ...
    if (
      ...
      const credential = await readCredentialVersion(tx, turn.apiCredentialId);
      if (!credential) {
        throw new KnowledgeBaseTurnReservationError(
          "CONFLICT",
