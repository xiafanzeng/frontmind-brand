...
import { loadKnowledgeBaseExecution } from "./knowledge-base-execution.js";
...
} from "../contracts/knowledge-base-public-progress.js";
import {
...
} from "../contracts/knowledge-base-output.js";
import { sanitizeFrontMindPublicText } from "./frontmind-public-brand.js";
import {
...
} from "./knowledge-base-artifact.js";
import {
...
} from "./knowledge-base-materialized-quality.js";
import { KNOWLEDGE_BASE_MATERIALIZED_V5_SKILL_CONTENT_HASH } from "./knowledge-base-tree-policy-rollout.js";
import { knowledgeBasePackageWriterTaskId } from "./knowledge-base-publication-binding.js";
...
} from "./knowledge-base-finalization.js";
import {
...
} from "./knowledge-base-customer-upload.js";
import {
...
} from "../contracts/knowledge-base-progress.js";
import {
...
} from "./knowledge-base-artifact-binding-service.js";
import { knowledgeBaseBrowserUpload } from "../contracts/knowledge-base-upload-status.js";
...
import type {createKnowledgeImagePresentation} from "./knowledge-image-presentation.js";
import type {createKnowledgeWorkbenchStages} from "./knowledge-workbench-stage.js";
import type {createKnowledgeBaseSourceLifecycle} from "./knowledge-base-local-source-lifecycle.js";
import type {createKnowledgeBaseMaterializedAssets} from "./knowledge-base-materialized-assets.js";
import type {createKnowledgeBasePublicResources} from "./knowledge-base-public-resource.js";
import type {createKnowledgeBaseConversationMessages} from "./knowledge-base-conversation-messages.js";
import type {createKnowledgeBaseAuthoritativeMessages} from "./knowledge-base-authoritative-message.js";

export interface KnowledgeProgressCore extends Pick<ReturnType<typeof createKnowledgeImagePresentation>, "projectKnowledgeImagePresentation">,Pick<ReturnType<typeof createKnowledgeWorkbenchStages>, "knowledgeWorkbenchStart"|"knowledgeWorkbenchStage">,Pick<ReturnType<typeof createKnowledgeBaseSourceLifecycle>, "markKnowledgeBaseBuildSourceGenerationTerminal">,Pick<ReturnType<typeof createKnowledgeBaseMaterializedAssets>, "projectKnowledgeBaseWorkingSetLeafResources"|"readValidatedActiveKnowledgeBaseWorkingSet">,Pick<ReturnType<typeof createKnowledgeBasePublicResources>, "knowledgeBaseOfficialLogoInternalIdentity"|"knowledgeBasePublicResource">,Pick<ReturnType<typeof createKnowledgeBaseConversationMessages>, "markKnowledgeBaseConversationCompletedInTransaction"|"markKnowledgeBaseConversationFailedInTransaction"|"persistKnowledgeBaseCompletionInTransaction"|"persistKnowledgeBasePresentationInTransaction">,Pick<ReturnType<typeof createKnowledgeBaseAuthoritativeMessages>, "matchesAuthoritativeKnowledgeBaseMessageTuple"|"parsedKnowledgeBaseMessageMetadata"> {
 conversations:CoreSqlTable<Conversation>; conversationTurns:CoreSqlTable<ConversationTurn>; messages:CoreSqlTable<Message>;
 knowledgeBaseBuildNodes:BrandSchema["knowledgeBaseBuildNodes"]; knowledgeBaseBuilds:BrandSchema["knowledgeBaseBuilds"]; knowledgeBaseConversationRetentionTombstones:BrandSchema["knowledgeBaseConversationRetentionTombstones"];
 getDb():Promise<MySql2Database<any>|null>; enterpriseOwnerPredicate(table:any,userId:number):SQL;
 lockCustomerProjectBusinessWrite(tx:any,userId:number):Promise<void>;
 knowledgeBaseSessionStorageId(userId:number,conversationId:string):string;enterpriseConversationStoragePrefix(userId:number):string;
 AuthServiceError:new(code:any,message:string)=>Error;
}
let projectKnowledgeImagePresentation: KnowledgeProgressCore["projectKnowledgeImagePresentation"];
let lockCustomerProjectBusinessWrite: KnowledgeProgressCore["lockCustomerProjectBusinessWrite"];
let knowledgeWorkbenchStart: KnowledgeProgressCore["knowledgeWorkbenchStart"];
let knowledgeWorkbenchStage: KnowledgeProgressCore["knowledgeWorkbenchStage"];
let knowledgeBaseSessionStorageId: KnowledgeProgressCore["knowledgeBaseSessionStorageId"];
let enterpriseConversationStoragePrefix: KnowledgeProgressCore["enterpriseConversationStoragePrefix"];
let enterpriseOwnerPredicate: KnowledgeProgressCore["enterpriseOwnerPredicate"];
let conversations: KnowledgeProgressCore["conversations"];
let conversationTurns: KnowledgeProgressCore["conversationTurns"];
let knowledgeBaseBuildNodes: KnowledgeProgressCore["knowledgeBaseBuildNodes"];
let knowledgeBaseBuilds: KnowledgeProgressCore["knowledgeBaseBuilds"];
let knowledgeBaseConversationRetentionTombstones: KnowledgeProgressCore["knowledgeBaseConversationRetentionTombstones"];
let messages: KnowledgeProgressCore["messages"];
let AuthServiceError: KnowledgeProgressCore["AuthServiceError"];
let getDb: KnowledgeProgressCore["getDb"];
let markKnowledgeBaseBuildSourceGenerationTerminal: KnowledgeProgressCore["markKnowledgeBaseBuildSourceGenerationTerminal"];
let projectKnowledgeBaseWorkingSetLeafResources: KnowledgeProgressCore["projectKnowledgeBaseWorkingSetLeafResources"];
let readValidatedActiveKnowledgeBaseWorkingSet: KnowledgeProgressCore["readValidatedActiveKnowledgeBaseWorkingSet"];
let knowledgeBaseOfficialLogoInternalIdentity: KnowledgeProgressCore["knowledgeBaseOfficialLogoInternalIdentity"];
let knowledgeBasePublicResource: KnowledgeProgressCore["knowledgeBasePublicResource"];
let markKnowledgeBaseConversationCompletedInTransaction: KnowledgeProgressCore["markKnowledgeBaseConversationCompletedInTransaction"];
let markKnowledgeBaseConversationFailedInTransaction: KnowledgeProgressCore["markKnowledgeBaseConversationFailedInTransaction"];
let persistKnowledgeBaseCompletionInTransaction: KnowledgeProgressCore["persistKnowledgeBaseCompletionInTransaction"];
let persistKnowledgeBasePresentationInTransaction: KnowledgeProgressCore["persistKnowledgeBasePresentationInTransaction"];
let matchesAuthoritativeKnowledgeBaseMessageTuple: KnowledgeProgressCore["matchesAuthoritativeKnowledgeBaseMessageTuple"];
let parsedKnowledgeBaseMessageMetadata: KnowledgeProgressCore["parsedKnowledgeBaseMessageMetadata"];
export function configureKnowledgeBaseProgress(core: KnowledgeProgressCore) { ({ projectKnowledgeImagePresentation, lockCustomerProjectBusinessWrite, knowledgeWorkbenchStart, knowledgeWorkbenchStage, knowledgeBaseSessionStorageId, enterpriseConversationStoragePrefix, enterpriseOwnerPredicate, conversations, conversationTurns, knowledgeBaseBuildNodes, knowledgeBaseBuilds, knowledgeBaseConversationRetentionTombstones, messages, AuthServiceError, getDb, markKnowledgeBaseBuildSourceGenerationTerminal, projectKnowledgeBaseWorkingSetLeafResources, readValidatedActiveKnowledgeBaseWorkingSet, knowledgeBaseOfficialLogoInternalIdentity, knowledgeBasePublicResource, markKnowledgeBaseConversationCompletedInTransaction, markKnowledgeBaseConversationFailedInTransaction, persistKnowledgeBaseCompletionInTransaction, persistKnowledgeBasePresentationInTransaction, matchesAuthoritativeKnowledgeBaseMessageTuple, parsedKnowledgeBaseMessageMetadata } = core); }
...
function buildDto(
  ...
  return {
    build: {
      ...
      hasPublishedSnapshot: Boolean(build.publishedAt || build.publishedSnapshotId),
      skillVersion: build.skillVersion,
      depthPolicy,
      researchSummary,
...
function projectKnowledgeBaseObservationSnapshot(input: {
  ...
  const localImagePresentation = projectKnowledgeImagePresentation({ build, node: currentRow, turn: presentationTurnRow });
  if (localImagePresentation) {
    approvedPresentation = {
      ...localImagePresentation,
      imageState: resources.length > 0 ? "attached" : "no_eligible_asset",
      resources,
    };
  }
...
export async function assertKnowledgeBaseReadyForUpdate(input: {
  ...
  if (
    ...
    (input.expectedGeneration !== undefined && input.expectedGeneration !== build.generation) ||
