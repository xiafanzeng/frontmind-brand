# FrontMind Brand module

This directory is the reviewed source projection for the `brand` module. It is not yet a public GitHub repository or a deployed standalone service. The active production/application baseline is `332d5ef072104283601682a3aca165a127c14e2c`.
