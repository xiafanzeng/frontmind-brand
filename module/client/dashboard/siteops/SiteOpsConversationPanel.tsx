...
import { WorkflowSection } from "@frontmind/module-ui/dashboard/Workflow";
import { useBusinessFlowState, readFlowString } from "../useBusinessFlowState";
import type { WorkbenchResourceRef } from "@frontmind/module-ui/contracts/workbench-task";
import {
...
} from "../../../contracts/siteops-contract";
import type {
  SiteOpsActInput,
  SiteOpsVisualFailureCategory,
} from "../../../contracts/siteops";
import { SITEOPS_CUSTOMER_DISPLAY_NAME } from "../../../contracts/siteops-branding";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@frontmind/module-ui/components/ui/alert-dialog";
import MarkdownRenderer from "@frontmind/module-ui/components/MarkdownRenderer";
import { copyToClipboard } from "@frontmind/module-ui/lib/utils";
import {
  AlertCircle,
  Check,
  ChevronLeft,
