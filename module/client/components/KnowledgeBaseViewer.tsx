...
import type { KnowledgeAsset, KnowledgeDocument } from "../../contracts/dashboard-types";
import { customerSafeKnowledgeAssetLabel } from "../../server/knowledge-base-public-artifacts";
      ...
      <div className="grid min-h-[520px] place-items-center rounded-[20px] border border-dashed border-[#d8cde3] bg-white/65 px-6 text-center">
        <div className="max-w-md">
          ...
          <p className="mt-2 text-sm leading-6 text-[#716a80]">
            在“构建流程”中完成首轮节点确认后，知识库会自动发布。后续修改可点击“更新知识库”启用新版本；管理员也可以上传已有知识库文件。
          </p>
        </div>
      </div>
    );
